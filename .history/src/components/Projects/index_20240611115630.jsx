...
const Projects = () => {
  return (
    <>
      ...
      <Grid container alignItems="center" alignContent="center" justifyContent="center" justifyItems="center" backgroundColor="red">
        <Grid item xs={12} alignItems="center" alignContent="center" justifyContent="center" justifyItems="center">
          <CustomCard
