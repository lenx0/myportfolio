      ...
      <Grid container justifyContent="center" mt={2}>
        ...
        >
          <CustomCard
            ...
            title={<Typography variant="h4" fontSize={24} fontWeight={700} color="#445964">Lenx Delivery</Typography>}
            description={<Typography>Projeto demonstrativo onde você consegue visualizar um cardápio, escolher o local de entrega e realizar o pedido.
            </Typography>}
            technologies={<Typography>Tecnologias: React, Javascript, HTML, CSS, Material-UI, Node, MongoDB, MapBox</Typography>}
          />
        </Grid>
      </Grid>
    </>
