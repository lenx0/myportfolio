  ...
  return (
    <Card sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <CardContent sx={{ flexGrow: 1 }}>
        ...
        <Typography variant="body1" component="div" sx={{ minHeight: 64 }}>
          {access}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {description}
        </Typography>
        <Typography variant="body2" mt={2} component="div" sx={{ minHeight: 64 }}>
          {technologies}
        </Typography>
      </CardContent>
      <Drawer anchor="right" open={drawerOpen} onClose={handleDrawerClose}>
        <Box
          ...
          width="80vw"
          height="100%"
          sx={{ maxWidth: 600 }} // Ajuste o tamanho máximo do drawer conforme necessário
        >
