  ...
  return (
    <Card
      sx={{
        ...
        boxShadow: "0 2px 8px #263138",
        transition: "0.30s",
        "&:hover": {
          boxShadow: "0 18px 16px #263138",
        },
      }}
    >
      <Box sx={{ p: 2 }}>
        <CardMedia
          ...
          sx={{ cursor: "pointer", objectFit: "contain", transition: "0.30s",
            "&:hover": {
              border: "0.3px solid #263138",
            }, }}
        />
        ...
        <CardContent sx={{ flexGrow: 1 }}>
          ...
          <Link href={access} sx={{ textDecoration: "none" }}>
            <Box>
              <Button variant="contained" sx={{ backgroundColor: "#263138" }}>Acessar</Button>
            </Box>
          </Link>
        </CardContent>
      </Box>
