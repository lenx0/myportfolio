...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "Este é um gerador de QRCode para qualquer um utilizar, adicionei também um histórico que salva automaticamente conforme você vai gerando.",
    technologies:
      "Tecnologias: Next, React, Javascript, HTML, CSS",
  },
  {
