...
const Home = () => {
  return (
    ...
    >
      <Grid item sx={{ textAlign: { xs: 'center', md: 'left' }, mb: { xs: 2, md: 0 } }}>
        ...
        <Button
          ...
          sx={{
            ...
            width: { xs: '80%', sm: '70%', md: 310 }, // Responsive width
      ...
      <Grid item sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'flex-start' }, mt: { xs: 2, md: 'auto' }, gap: 2 }}>
        <Box>
          <img src={Github} alt="Github" style={{ width: '40px', height: '40px' }} /> {/* Set icon size */}
        </Box>
        <Box>
          <img src={Linkedin} alt="LinkedIn" style={{ width: '40px', height: '40px' }} /> {/* Set icon size */}
        </Box>
      </Grid>
