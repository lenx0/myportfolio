  ...
  const experiences = [
    {
      ...
      titleDescription:
        "Atuei como desenvolvedor Front-end desenvolvendo um poderoso sistema de vendas com integração ao ERP da TOTSV Virtual Age.",
        resume: " Na Aglabs participei de uma equipe desenvolvendo novas features e corrigindo eventuais problemas, bem como realizando testes e realizando deploy na AWS",
    },
    {
