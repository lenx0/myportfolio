  ...
  const experiences = [
    {
      ...
      titleDescription:
        ...
        resume: "Fiz parte de uma equipe desenvolvendo novas features e corrigindo eventuais problemas, bem como realizando testes e realizando deploy na AWS",
    },
    {
      ...
      resume: "Atuei desenvolvendo ferramentas para facilitar alguns processos dentro da empresa"
    },
  ];
      ...
      <Grid container spacing={2} sx={{ mt: 5 }}>
        {experiences.map((experience, index) => (
          <Grid item xs={12} md={6} key={index}>
            <Paper
              elevation={3}
              sx={{ p: 3, minHeight: "30vh", backgroundColor: "#263138", color: "white" }}
            >
