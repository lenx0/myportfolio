  ...
  const experiences = [
    {
      ...
      resume: `Atuei em um projeto desenvolvendo o front-end para um ERP desde a fase inicial até o 
        lançamento sendo este um sistema de vendas de produtos fitness utilizado pelos 
