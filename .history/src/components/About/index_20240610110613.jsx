    ...
    <Stack alignItems="center" spacing={5} mt={20}>
      ...
      <Stack>
        <Typography variant="body2" fontSize={24} color="#445964">
          ...
          deploy na nuvem.
          <br />
          Sou um profissional insistente, analítico e cuidadoso. Gosto de pensar
          fora da caixa, trabalhar em equipe e contribuir com novas ideias.
          <br />
          Estou constantemente estudando e me atualizando para não ficar para
          trás nessa esteira infinita que percorremos no desenvolvimento de
          software.
          <br />
          Sou apaixonado por tecnologia e gosto de compartilhar minhas
