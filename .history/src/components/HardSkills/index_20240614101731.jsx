...
const HardSkills = () => {
  return (
    <Stack id="hardskills-section" direction="row" gap={6} flexWrap="wrap" justifyContent="center">
      <Typography variant="h4" fontSize={64} fontWeight={700} color="#445964">
        Hard Skills
      </Typography>
      <Stack direction="row" spacing={4} flexWrap="wrap" p="0 20px 0 30px" justifyContent="center">
