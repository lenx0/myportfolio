...
const HardSkills = () => {
  return (
    <Stack id="hardskills-section" direction="row" gap={7} flexWrap="wrap" justifyContent="center">
      <Typography variant="h4" fontSize={64} fontWeight={700} color="#445964">
        Hard Skills
      </Typography>
      <Stack direction="row" spacing={4} flexWrap="wrap" gap={2} justifyContent="center">
